...
class Clyde{
    ...
    addAnimations(){
        ...
        this.sprite.addKeyframe(BLINKY_STOP_RIGHT, [0, 128, 32, 32]);

        this.sprite.addAnimation();
        this.sprite.addKeyframe(BLINKY_EAT_RIGHT, [0, 128, 32, 32]);
        this.sprite.addKeyframe(BLINKY_EAT_RIGHT, [32, 128, 32, 32]);

        // Add movement LEFT
        this.sprite.addAnimation();
        this.sprite.addKeyframe(BLINKY_STOP_LEFT, [64, 128, 32, 32])

        this.sprite.addAnimation();
        this.sprite.addKeyframe(BLINKY_EAT_LEFT, [64, 128, 32, 32]);
        this.sprite.addKeyframe(BLINKY_EAT_LEFT, [96, 128, 32, 32]);

        // Add movement UP
        this.sprite.addAnimation();
        this.sprite.addKeyframe(BLINKY_STOP_UP, [128, 128, 32, 32])

        this.sprite.addAnimation();
        this.sprite.addKeyframe(BLINKY_EAT_UP, [128, 128, 32, 32]);
        this.sprite.addKeyframe(BLINKY_EAT_UP, [160, 128, 32, 32]);

        // Add movement DOWN
        this.sprite.addAnimation();
        this.sprite.addKeyframe(SBLINKY_STOP_DOWN, [0, 160, 32, 32])


        this.sprite.addAnimation();
        this.sprite.addKeyframe(BLINKY_EAT_DOWN, [0, 160, 32, 32]);
        this.sprite.addKeyframe(BLINKY_EAT_DOWN, [32, 160, 32, 32]);
