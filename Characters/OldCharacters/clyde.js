...
class Clyde{
    ...
    constructor(map, level){
        ...
        this.sprite = new Sprite( 15* (map.tileSize[0]) + map.basePos[0], 14*(map.tileSize[1]) + map.basePos[1] - 8, 32, 32, 16, t);
    ...
    addAnimations(){
        ...
        this.sprite.addKeyframe(ghost_directions.EAT_RIGHT, [0, 128, 32, 32]);
        this.sprite.addKeyframe(ghost_directions.EAT_RIGHT, [32, 128, 32, 32]);

        // Add movement LEFT
        this.sprite.addAnimation();
        this.sprite.addKeyframe(ghost_directions.EAT_LEFT, [64, 128, 32, 32]);
        this.sprite.addKeyframe(ghost_directions.EAT_LEFT, [96, 128, 32, 32]);

        // Add movement UP
        this.sprite.addAnimation();
        this.sprite.addKeyframe(ghost_directions.EAT_UP, [128, 128, 32, 32]);
        this.sprite.addKeyframe(ghost_directions.EAT_UP, [160, 128, 32, 32]);

        // Add movement DOWN
        this.sprite.addAnimation();
        this.sprite.addKeyframe(ghost_directions.EAT_DOWN, [0, 160, 32, 32]);
        this.sprite.addKeyframe(ghost_directions.EAT_DOWN, [32, 160, 32, 32]);
    ...
    reset(ghost){
        ghost.sprite.x = 15* (ghost.map.tileSize[0]) + ghost.map.basePos[0];
